...
public class SSLFactory_Client {
    public static void main(String[] args){
       ...
       SSLContext sslContext = sclient.createSSLContext(caPath);
       try {
    ...
    private SSLContext createSSLContext(String caPath){
       try{
           KeyStore keyStore = KeyStore.getInstance("JKS");
           keyStore.load(new FileInputStream(caPath),"changeit".toCharArray());
           // Create key manager
